 ...
 * Fajl:    trapPtoP.py
 *
 * Svrha:   Paralelna implementacija trapezoidalne formule
            koristeči komunikaciju točka-do-točke.
 *
 * Ulaz:   a, b, n
 ...
 *
 * Algoritam:
 *    0.   Svaki proces izračunava svoje specifikacije vezane za lokalni_a i lokalni_b.
...
# Komunikacija.
# Korijenski proces odnosno proces ranga 0 prima rezultate od svih ostalih procesa i sumira ih.
if rank == 0:
        ukupna_suma = integral[0]
        for i in range(1, size):
                comm.Recv(recv_buffer, source=i)
                ukupna_suma += recv_buffer[0]
else:
        # Svi procesi koji nemaju rang 0, šalju svoje rezutate procesu ranga 0.
...
if comm.rank == 0:
        ...
        , a, "do", b, "iznosi", ukupna_suma, "\nPritom smo koristili komunikaciju tocka do tocke.")
