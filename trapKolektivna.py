 ...
 *    3a. Korsiteći reduce vrši se redukcija(suma), podataka "integral" koja je sprema u varijablu ukupna_suma i šalje se korijenskom procesu.
 *    3b. Proces ranga 0 ispisuje konačni rezultat.
 *
